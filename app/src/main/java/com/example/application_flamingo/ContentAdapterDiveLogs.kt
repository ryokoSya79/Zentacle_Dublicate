...
class ContentAdapterDiveLogs(val listener: Listener): RecyclerView.Adapter<ContentAdapterDiveLogs.ContentHolder>(){

    var contentList = ArrayList<GetDataContent>()
    ...
    class ContentHolder(item: View): RecyclerView.ViewHolder(item){
        ...
        fun bind(getDataContent: GetDataContent, listener: Listener){
            ...
            image.setOnClickListener {
                listener.onClickDiveLogs(getDataContent)
            }
    ...
    fun addContentDiveLogs(getDataContents: GetDataContent){
        contentList.add(getDataContents)
        notifyDataSetChanged()
    }

    interface Listener{
        fun onClickDiveLogs(getDataContent: GetDataContent)
    }
